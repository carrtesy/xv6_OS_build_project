...
main(void)
{
  ...
  52:	e8 79 04 00 00       	call   4d0 <printf>
		printf(1, "Student ID: 2014311577\n");
  57:	58                   	pop    %eax
  58:	5a                   	pop    %edx
  59:	68 43 08 00 00       	push   $0x843
  5e:	6a 01                	push   $0x1
  60:	e8 6b 04 00 00       	call   4d0 <printf>
		printf(1, "Name: Dongmin Kim\n");
  65:	59                   	pop    %ecx
  66:	5b                   	pop    %ebx
  67:	68 5b 08 00 00       	push   $0x85b
  6c:	6a 01                	push   $0x1
  6e:	e8 5d 04 00 00       	call   4d0 <printf>
		printf(1, "Message from developer: Welcome to xv6 OS!\n");
  73:	58                   	pop    %eax
  74:	5a                   	pop    %edx
  75:	68 a4 08 00 00       	push   $0x8a4
  7a:	6a 01                	push   $0x1
  7c:	e8 4f 04 00 00       	call   4d0 <printf>
    pid = fork();
  81:	e8 e4 02 00 00       	call   36a <fork>
    if(pid < 0){
  ...
  98:	e8 dd 02 00 00       	call   37a <wait>
  ...
  c2:	e8 09 04 00 00       	call   4d0 <printf>
      exit();
  c7:	e8 a6 02 00 00       	call   372 <exit>
      exec("sh", argv);
  cc:	50                   	push   %eax
  cd:	50                   	push   %eax
  ce:	68 80 0b 00 00       	push   $0xb80
  d3:	68 81 08 00 00       	push   $0x881
  d8:	e8 cd 02 00 00       	call   3aa <exec>
      printf(1, "init: exec sh failed\n");
  dd:	5a                   	pop    %edx
  de:	59                   	pop    %ecx
  df:	68 84 08 00 00       	push   $0x884
  e4:	6a 01                	push   $0x1
  e6:	e8 e5 03 00 00       	call   4d0 <printf>
      exit();
  eb:	e8 82 02 00 00       	call   372 <exit>
    mknod("console", 1, 1);
  f0:	51                   	push   %ecx
  f1:	6a 01                	push   $0x1
  f3:	6a 01                	push   $0x1
  f5:	68 28 08 00 00       	push   $0x828
  fa:	e8 bb 02 00 00       	call   3ba <mknod>
    open("console", O_RDWR);
  ff:	5b                   	pop    %ebx
 100:	58                   	pop    %eax
 101:	6a 02                	push   $0x2
 103:	68 28 08 00 00       	push   $0x828
 108:	e8 a5 02 00 00       	call   3b2 <open>
 ...
 439:	85 d2                	test   %edx,%edx
{
 ...
 467:	f7 f1                	div    %ecx
 469:	0f b6 92 d8 08 00 00 	movzbl 0x8d8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb d0 08 00 00       	mov    $0x8d0,%ebx
        while(*s != 0){
 ...
 6a1:	a1 88 0b 00 00       	mov    0xb88,%eax
{
 ...
 6dd:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6df:	a3 88 0b 00 00       	mov    %eax,0xb88
}
 6e4:	5b                   	pop    %ebx
 6e5:	5e                   	pop    %esi
 6e6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 739:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 73c:	8b 15 88 0b 00 00    	mov    0xb88,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7d7:	89 15 88 0b 00 00    	mov    %edx,0xb88
}
 ...
 7e9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 7f0:	c7 05 88 0b 00 00 8c 	movl   $0xb8c,0xb88
 7f7:	0b 00 00 
 7fa:	c7 05 8c 0b 00 00 8c 	movl   $0xb8c,0xb8c
 801:	0b 00 00 
    base.s.size = 0;
 804:	b8 8c 0b 00 00       	mov    $0xb8c,%eax
 809:	c7 05 90 0b 00 00 00 	movl   $0x0,0xb90
 810:	00 00 00 
