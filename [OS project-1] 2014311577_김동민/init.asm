...
main(void)
{
  ...
  cc:	50                   	push   %eax
  cd:	50                   	push   %eax
  ce:	68 90 0b 00 00       	push   $0xb90
  d3:	68 91 08 00 00       	push   $0x891
  ...
  f1:	6a 01                	push   $0x1
  f3:	6a 01                	push   $0x1
  f5:	68 38 08 00 00       	push   $0x838
  fa:	e8 bb 02 00 00       	call   3ba <mknod>
    open("console", O_RDWR);
  ff:	5b                   	pop    %ebx
 100:	58                   	pop    %eax
 101:	6a 02                	push   $0x2
 103:	68 38 08 00 00       	push   $0x838
 ...
 449:	85 d2                	test   %edx,%edx
{
 ...
 477:	f7 f1                	div    %ecx
 479:	0f b6 92 e8 08 00 00 	movzbl 0x8e8(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb e0 08 00 00       	mov    $0x8e0,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 98 0b 00 00       	mov    0xb98,%eax
{
 ...
 6ed:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6ef:	a3 98 0b 00 00       	mov    %eax,0xb98
}
 6f4:	5b                   	pop    %ebx
 6f5:	5e                   	pop    %esi
 6f6:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 15 98 0b 00 00    	mov    0xb98,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7e4:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 7e7:	89 15 98 0b 00 00    	mov    %edx,0xb98
}
 ...
 807:	0b 00 00 
 80a:	c7 05 9c 0b 00 00 9c 	movl   $0xb9c,0xb9c
 811:	0b 00 00 
    base.s.size = 0;
 814:	b8 9c 0b 00 00       	mov    $0xb9c,%eax
 819:	c7 05 a0 0b 00 00 00 	movl   $0x0,0xba0
 820:	00 00 00 
