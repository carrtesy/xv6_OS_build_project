   ...
   7:	83 39 02             	cmpl   $0x2,(%ecx)
{
  ...
  20:	e8 1b 04 00 00       	call   440 <printf>
    exit();
  25:	e8 a8 02 00 00       	call   2d2 <exit>
  }
  ...
  result = getnice(pid);
  3a:	e8 43 03 00 00       	call   382 <getnice>

  if (result != -1)
  3f:	83 c4 10             	add    $0x10,%esp
  42:	83 c0 01             	add    $0x1,%eax
  45:	74 1f                	je     66 <main+0x66>
    printf(1, "Priority for pid %d is: %d\n", pid, getnice(pid));
  47:	83 ec 0c             	sub    $0xc,%esp
  4a:	53                   	push   %ebx
  4b:	e8 32 03 00 00       	call   382 <getnice>
  50:	50                   	push   %eax
  51:	53                   	push   %ebx
  52:	68 e0 07 00 00       	push   $0x7e0
  57:	6a 01                	push   $0x1
  ...
  66:	50                   	push   %eax
  67:	53                   	push   %ebx
  68:	68 bc 07 00 00       	push   $0x7bc
  6d:	6a 01                	push   $0x1
  6f:	e8 cc 03 00 00       	call   440 <printf>
  74:	83 c4 10             	add    $0x10,%esp
  77:	eb e8                	jmp    61 <main+0x61>
  79:	66 90                	xchg   %ax,%ax
  7b:	66 90                	xchg   %ax,%ax
  7d:	66 90                	xchg   %ax,%ax
  7f:	90                   	nop
...
00000440 <printf>:
 ...
 5f9:	bb fc 07 00 00       	mov    $0x7fc,%ebx
...
00000610 <free>:
 ...
 64f:	a3 ac 0a 00 00       	mov    %eax,0xaac
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 657:	5d                   	pop    %ebp
 ...
 68a:	a3 ac 0a 00 00       	mov    %eax,0xaac
...
000006a0 <malloc>:
 ...
 6ac:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
 ...
 6f1:	39 05 ac 0a 00 00    	cmp    %eax,0xaac
 ...
 71b:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
 ...
 747:	89 15 ac 0a 00 00    	mov    %edx,0xaac
 ...
 767:	0a 00 00 
 76a:	c7 05 b0 0a 00 00 b0 	movl   $0xab0,0xab0
 771:	0a 00 00 
 774:	b8 b0 0a 00 00       	mov    $0xab0,%eax
