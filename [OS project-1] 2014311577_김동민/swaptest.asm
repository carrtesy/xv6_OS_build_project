   ...
   f:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  2c:	6a 31                	push   $0x31
  2e:	68 c0 1a 00 00       	push   $0x1ac0
  33:	e8 28 01 00 00       	call   160 <memset>

	swapwrite(buffer1, blkno);
  38:	58                   	pop    %eax
  39:	5a                   	pop    %edx
  3a:	53                   	push   %ebx
  3b:	68 c0 1a 00 00       	push   $0x1ac0
  40:	e8 65 03 00 00       	call   3aa <swapwrite>

	swapread(buffer2, blkno);
  45:	59                   	pop    %ecx
  46:	58                   	pop    %eax
  47:	53                   	push   %ebx
  48:	68 c0 0a 00 00       	push   $0xac0

	for ( i=0; i <4096; ++i ) {
  4d:	31 db                	xor    %ebx,%ebx
	swapread(buffer2, blkno);
  4f:	e8 4e 03 00 00       	call   3a2 <swapread>
  54:	83 c4 10             	add    $0x10,%esp
  57:	89 f6                	mov    %esi,%esi
  59:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
		if ( buffer1[i] != buffer2[i] )
  60:	0f b6 83 c0 0a 00 00 	movzbl 0xac0(%ebx),%eax
  67:	38 83 c0 1a 00 00    	cmp    %al,0x1ac0(%ebx)
  6d:	74 13                	je     82 <main+0x82>
			printf(1, "different at %d\n", i);
  6f:	83 ec 04             	sub    $0x4,%esp
  72:	53                   	push   %ebx
  73:	68 d9 07 00 00       	push   $0x7d9
  78:	6a 01                	push   $0x1
  ...
  92:	52                   	push   %edx
  93:	ff 30                	pushl  (%eax)
  95:	68 c8 07 00 00       	push   $0x7c8
  9a:	6a 01                	push   $0x1
  9c:	e8 cf 03 00 00       	call   470 <printf>
		exit();
  a1:	e8 5c 02 00 00       	call   302 <exit>
  a6:	66 90                	xchg   %ax,%ax
  a8:	66 90                	xchg   %ax,%ax
  aa:	66 90                	xchg   %ax,%ax
  ac:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 624:	e9 8f fe ff ff       	jmp    4b8 <printf+0x48>
          s = "(null)";
 629:	bb ea 07 00 00       	mov    $0x7ea,%ebx
        while(*s != 0){
